...
#SBATCH --job-name=nellppar_l1grtv0.1
#SBATCH --error=myJobnellppar_l1grtv0.1.err            # standard error file
#SBATCH --output=myJobnellppar_l1grtv0.1.out           # standard output file
