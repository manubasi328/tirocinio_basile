...
#SBATCH --job-name=nellppar
#SBATCH --error=myJobnellppar.err            # standard error file
#SBATCH --output=myJobnellppar.out           # standard output file
...
/usr/bin/time -v $HOME/bin/swipl --stack-limit=450g compute_par.pl
conda deactivate
