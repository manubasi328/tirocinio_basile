...
#SBATCH --job-name=nellpparl1g5
#SBATCH --error=myJobnellppar_l1g5.err            # standard error file
#SBATCH --output=myJobnellppar_l1g5.out           # standard output file
...
/usr/bin/time -v $HOME/bin/swipl --stack-limit=450g compute_par_l1g5.pl
conda deactivate
