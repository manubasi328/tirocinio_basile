...
#SBATCH --job-name=fbklpl1g20
#SBATCH --error=myJobfbklppl1g20.err            # standard error file
#SBATCH --output=myJobfbklppl1g20.out           # standard output file
...
/usr/bin/time -v $HOME/bin/swipl --stack-limit=450g compute_par_l1g20.pl
conda deactivate
