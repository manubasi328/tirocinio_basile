...
#SBATCH --job-name=fbklpl2g5
#SBATCH --error=myJobfbklppl2g5.err            # standard error file
#SBATCH --output=myJobfbklppl2g5.out           # standard output file
...
/usr/bin/time -v $HOME/bin/swipl --stack-limit=450g compute_par_l2g5.pl
conda deactivate
