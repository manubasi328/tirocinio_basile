...
#SBATCH --job-name=phlpparl2
#SBATCH --error=myJobphlppar_l2.err            # standard error file
#SBATCH --output=myJobphlppar_l2.out           # standard output file
...
/usr/bin/time -v $HOME/bin/swipl --stack-limit=400g compute_par_l2.pl
conda deactivate
