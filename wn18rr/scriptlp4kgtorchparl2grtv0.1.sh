...
#SBATCH --job-name=wnlppar_l2grtv0.1
#SBATCH --error=myJobwnlppar_l2grtv0.1.err            # standard error file
#SBATCH --output=myJobwnlppar_l2grtv0.1.out           # standard output file
