...
#SBATCH --job-name=wnlpparl1g5
#SBATCH --error=myJobwnlppar_l1g5.err            # standard error file
#SBATCH --output=myJobwnlppar_l1g5.out           # standard output file
...
/usr/bin/time -v $HOME/bin/swipl --stack-limit=490g compute_par_l1g5.pl
conda deactivate
