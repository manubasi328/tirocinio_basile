...
#SBATCH --job-name=natlppar_l1grtv0.1
#SBATCH --error=myJobnatlppar_l1grtv0.1.err            # standard error file
#SBATCH --output=myJobnatlppar_l1grtv0.1.out           # standard output file
