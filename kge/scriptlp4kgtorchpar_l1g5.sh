...
#SBATCH --job-name=kgelpparl1g5
#SBATCH --error=myJobkgelppar_l1g5.err            # standard error file
#SBATCH --output=myJobkgelppar_l1g5.out           # standard output file
...
/usr/bin/time -v $HOME/bin/swipl --stack-limit=400g compute_par_l1g5.pl
conda deactivate
