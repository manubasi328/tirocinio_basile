...
#SBATCH --job-name=kgelppar_l2grtv0.1
#SBATCH --error=myJobkgelppar_l2grtv0.1.err            # standard error file
#SBATCH --output=myJobkgelppar_l2grtv0.1.out           # standard output file
