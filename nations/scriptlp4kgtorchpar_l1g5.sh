...
#SBATCH --job-name=natlppar_l1g5
#SBATCH --error=myJobnatlppar_l1g5.err            # standard error file
#SBATCH --output=myJobnatlppar_l1g5.out           # standard output file
...
/usr/bin/time -v $HOME/bin/swipl --stack-limit=100g compute_par_l1g5.pl
conda deactivate
