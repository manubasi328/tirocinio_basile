...
#SBATCH --job-name=natlppar_l2
#SBATCH --error=myJobnatlppar_l2.err            # standard error file
#SBATCH --output=myJobnatlppar_l2.out           # standard output file
...
/usr/bin/time -v $HOME/bin/swipl --stack-limit=100g compute_par_l2.pl
conda deactivate
